...
SHOW_PATH=$(tmux show-option -gv @sydney-lights-tmux_show_path 2>/dev/null)
PATH_FORMAT=$(tmux show-option -gv @sydney-lights-tmux_path_format 2>/dev/null) # full | relative
